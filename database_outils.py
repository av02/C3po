...
class appelsBDD:
    ...
    def add_discord_id(self, tag, id, permission_ecraser=False):
        ...
        """
        if len(self.appel_bdd("SELECT discordID FROM nommage WHERE tagIG='{}'".format(tag)))!=1:
            raise ValueError()
        if not permission_ecraser and self.appel_bdd("SELECT discordID FROM nommage WHERE tagIG='{}'".format(tag))[0] != (None,):
    ...
    def edit_pseudo(self, tag, pseudo):
        ...
        """
        self.appel_bdd(
            "UPDATE nommage SET pseudoIG='{}' WHERE tagIG='{}'".format(pseudo, tag))

    def edit_clan(self, tag, clan=None):
        """met a jour le clan du joueur avec son nouveau clan"""
        self.appel_bdd(
            """UPDATE nommage SET clan='{}' WHERE tagIG='{}'""".format(clan, tag))
    ...
    def add_def_gdc(self, tag, perf: bool):
        ...
        self.appel_bdd("""UPDATE nommage SET nbdefhdv={},perfdefhdv={} WHERE tagIG='{}'""".format(
    ...
    def add_don(self, tag, dons,th,pseudo,clan):
        ...
        self.appel_bdd("""UPDATE nommage SET donne={} WHERE tagIG='{}'""".format(
    ...
    def add_recu(self, tag, recu,th,pseudo,clan):
        ...
        valeur_anterieur = self.appel_bdd("""SELECT recu FROM nommage 
                                        WHERE tagIG='{}'""".format(tag))[0][0]
        self.appel_bdd("""UPDATE nommage SET recu={} WHERE tagIG='{}'""".format(
    ...
    def reduire_dons(self, facteur=2):
        ...
        self.appel_bdd(
            """UPDATE nommage SET donne=donne/{0},recu=recu/{0}""".format(facteur))
